...
{
    trip ship;
    cout << "\n Id индивидуального договора: " << ship.idDogovora;
    cout << "\n Имя заёмщика: " << ship.name;
    cout << "\n Год рождения: " << ship.birthY;
    cout << "\n Город проживания: " << ship.town;
    cout << "\n Контактный номер телефона: " << ship.telNubmer;
    cout << "\n Место работы: " << ship.placeWork;
    cout << "\n Средний ежемесячный доход: " << ship.income;
    cout << "\n Тип учетной записи (Снятие (W)/Накопление (A)): " << ship.type;
    cout << "\n Баланс учетной записи: " << ship.deposit;
}
...
int main() {
    {
        ...
        do
        {
            ...
            cout << "  4 - сортировка по названию яхт" << endl;//case3
            cout << "  3 - сортировка по длинне яхт" << endl;//case4
